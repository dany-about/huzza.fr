...
Accomplishment.create!(title: "No Longer A Newcomer", name: "Mon premier défi créé !", icon_class:"fas fa-fish")
Accomplishment.create!(title: "Michael Scott", name: "Mon premier ami !", icon_class:"fas fa-fish")
Accomplishment.create!(title: "Dare Or Dare", name: "Mon premier challenge envoyé !", icon_class:"fas fa-fish")
Accomplishment.create!(title: "A New Adventure Begins", name: "Ma première participation à un défi !", icon_class:"fas fa-fish")
Accomplishment.create!(title: "Look At Me", name: "Mon premier trophée posté !", icon_class:"fas fa-fish")
Accomplishment.create!(title: "The Rock", name: "Mon premier défi réalisé !", icon_class:"fas fa-fish")
Accomplishment.create!(title: "Model Citizen", name: "Mon premier vote de difficulté !", icon_class:"fas fa-fish")
Accomplishment.create!(title: "Serial Rater", name: "A voté 10 fois la difficulté d'un défi", icon_class:"fas fa-fish")
