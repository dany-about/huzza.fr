...
dare9 = Dare.create!(title: "get your own floating party", description: "get a nautic license, rent a yatch, invite people and have a huge party"*3, creator: admin, category: category_12)
...
dare11 = Dare.create!(title: "", description: "buy some fruits, walk down the streets, give some to homeless people"*3, creator: admin, category: category_5)
