...
dare_dany = Dare.create!(creator: dany, title: "Ralier Marseille - Montcuq en autostop sans dépenser le moindre euro", description: "Je projette cet été de me rendre à Montcuq, pour y faire le tour à pieds. La SNCF n'ayant, à mon grand regret, pas encore déployée de ligne à grande vitesse à destination de Montcuq, j'ai pris la lourde décision de m'y rendre en stop.", category: category_2)
